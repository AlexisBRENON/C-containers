...
Element premierElementListe(Liste l);
/* Precondition : testListeVide(l)==false */
/* Resultat : valeur de l'Element contenu dans la 1ere Cellule */
...
/* Resultat : valeur de l'Element contenu dans la Cellule */

void affichageListe(Liste l, void (*fAfficheElmt)(Element));
/* Precondition : l initialisee et manipulee uniquement a travers les  */
/*                 operations du module */
/* Postcondition : Affichage exhaustif de tous les elements de l */

void ajoutEnTeteListe(Element e,Liste *l,
...
/* Postcondition : L'Element e est ajoute en tete de *l */
...
void ajoutEnQueueListe(Element e,Liste *l,
					void (*fInitElmt)(Element*),
					void (*fCopyElmt)(Element, Element));
/* Precondition : *l et e initialises et manipules uniquement a travers les  */
/*                 operations de leurs modules respectifs */
/* Precondition : L'Element e est ajoute en fin de la liste *l */
